...
\address{(+1) 412-251-1130 \\ \href{xuejianwang.com}{xuejianwang.com} \\ \href{mailto:xuejianw@andrew.cmu.edu}{xuejianw@andrew.cmu.edu}  }
...
\begin{rSubsection}{Detecting Unseen Risk Class in Online Textual Data}{Sep. 2018 - Mar. 2019}{Advisor: Prof. Leman Akoglu}{DATA Lab, CMU}
\item Detecting emerging risk class from large corpus of text on the Internet, mainly news and twitters
\item Submitted to ECML-PKDD.
\end{rSubsection}
